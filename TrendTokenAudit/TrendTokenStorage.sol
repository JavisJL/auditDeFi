...
contract TrendTokenStorage {
     ...
     */
    IXTT public xtt = IXTT(0x6F26Bc9b4CfBD3172549392c38Ae5c6A5e0cfAef); // currently XDP address, change to deployed XTT
    ...
    /**
     * @notice Address of PancakeRouter to make trades for XTT and XDP
     */
    ...
    /**
     * @notice The amount of Trend Tokens held in reserves from performance and redeem fees
     * @dev Reserves can go to burn XTT or to fee recipient wallet
    
    uint public reservesTrendTokens;
 */
