...
contract VenusIntegration {
   ...
   // ----- CONTRACT ACCOUNT DATA ------ // 
    ...
    function ensureNonzeroAddress(address addr) public pure {
        require(address(addr) != address(0), "!zeroAddr");
    }


    function returnCompVenus() public view returns(ICompVenus) {
     ...
     */
    function screenshot(IVBep20 _vTokens) public view returns(uint,uint,uint)  {
     ...
     */
    function exchangeVBEP20(IVBep20 _vTokens) public view returns(uint) {
     ...
     */
    function enableSingleCol(address _vToken) public {
     ...
     */
    function disableCol( IVBep20 _vToken) public { // Allowing collateral and borrow of entered markets
     ...
     */ 
    function tokenEntered(IVBep20 _vToken) public view returns(bool) {
     ...
     */
    function collateralSupply(IERC20 _bep20, IVBep20 vToken, uint amountBEP20) public {  //supply BNB as collateral 
     ...
     */
    function collateralRedeem(IVBep20 _vToken, uint amountBEP20) public { // withdrawal BNB collateral 
     ...
     */
    function collateralFactor(IVBep20 vToken) public view returns(uint) {
     ...
     */
    function borrowVenus(IVBep20 vToken, uint amountBorrow) public {
        ensureNonzeroAddress(address(vToken));
     ...
     */
    function repayVenus(IERC20 underlying, IVBep20 vToken, uint amountRepay) public {
        ensureNonzeroAddress(address(vToken));
        if (underlying == wbnb) {
