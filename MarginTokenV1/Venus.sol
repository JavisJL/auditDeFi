...
contract VenusIntegration  {
    ...
    */
    ...
    /**
     * testnet: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd,0x12D56a6F126a39A6C6AabDbf9fE49509b6681767
     * mainnet:
     */
    constructor(address _wbnb, address _compTT) public {
     ...
     * @dev Comment out for live deployements
   ...
   // ----- CONTRACT ACCOUNT DATA ------ // 
    ...
    /**
     * @notice Fetch prices of tokens from CompTT chainlink Oracle
     * @param _vTokens The underlying assets dToken to get price of
     
    function priceBEP20(IVBep20 _vTokens) internal view returns(uint256) { 
        uint price = priceOracle.getUnderlyingPrice(address(_vTokens));
     ...
     * @param _vTokens List of vTokens to be enabled
     */
    function enableCol(address[] memory _vTokens) internal {
        returnCompVenus().enterMarkets(_vTokens);
    }
