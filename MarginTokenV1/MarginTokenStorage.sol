...
contract MarginTokenStorage {
    ...
    //event NewCompVenus(address oldCompVenus, address newCompVenus);
    event UpdateCompAndModels(address oldCompTT, address newCompTT, address oldIncentive, address newIncentive);
    ...
    /** combined
     * @notice Emitted when venusOpen state changes
     */
    //event VenusOpen(bool oldState, bool newState);

    /**
     * @notice Emitted when venusOpen and/or pauseTrendToken state changes
     */
    event UpdateVenusAndPauseState(bool oldVenus, bool newVenus, bool oldPause, bool newPuase);
     ...
     */
    IERC20 public xvs = IERC20(0x4EaB863A16fFf3190ACbF0b2043fc25A113C7ef7);//IERC20(0xf79c28eB5bd0cC10B58F04DfF7c34d0c8D39BdE6);
    ...
    // ------------------- SUPPLY AND BORROW CAPABILITIES -------------------- // 
