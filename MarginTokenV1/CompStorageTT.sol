...
contract ComptrollerStorage is UnitrollerAdminStorage {
    ...
    struct TrendToken {
        ...
        // @dev borrowFactor 80% with colFactor 60% can go max 1.90x leverage
    ...
    /**
     * @notice Maximum price discrepancy between vToken underlying and underlying from this comptroller
     *         oracle for the vToken to be added
     */
    uint priceDiscrepancyMax = 0.001e18;
    ...
    struct Underlying {
        ...
        // @notice The maximum price % between Oracle and VenusOracle for this underlying
        // @dev Value of 0.001e18 means maximum 0.10% price difference between Oracle and VenusOracle
        //uint maxPriceDifference;
